  ...
  <v-app light>
    ...
    <v-footer app color="grey lighten-3">
      <v-layout justify-center class="pt-2 pb-2">
        <span>&copy; {{ new Date().getFullYear() }} - Desenvolvido com <a href="https://nuxtjs.org/" target="_blank">Nuxt.js</a> e <a href="https://vuetifyjs.com/" target="_blank">Vuetify.js</a></span>
      </v-layout>
    </v-footer>
